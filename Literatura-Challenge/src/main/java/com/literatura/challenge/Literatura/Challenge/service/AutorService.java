...
import com.literatura.challenge.Literatura.Challenge.repository.AutorRepository;
...
public class AutorService {
    ...
    public Autor actualizarAutor(Long id, Autor autorDetalles) {
        Autor autor = autorRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Autor no encontrado en la base de datos"));
